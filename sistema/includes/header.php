...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				<!-- Topbar -->
				<nav class="navbar navbar-expand navbar-light bg-light text-black topbar mb-4 static-top shadow">
					...
					<div class="input-group">
						<h6 style="color: orange;">CSLB SYSTEM</h6>
						<p class="ml-auto"><strong>CA US, </strong><?php echo fechaPeru(); ?></p>
					</div>
					...
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item dropdown no-arrow">
							<a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
								<span class="mr-2 d-none d-lg-inline small text-black" style="color: #333;"><?php echo $_SESSION['nombre']; ?></span>
							</a>
